...
namespace GameOne
{
    abstract class Sprite
    {
        ...
        public Sprite(SpriteSheet spriteSheet, Vector2 position, Point collisionOffset, Vector2 speed)
        {
        ...
        public Rectangle collisionRect
        {
            get
            {
                return new Rectangle(
                    ...
                    spriteSheet.currentSegment.frameSize.X - (collisionOffset.X * 2),
                    spriteSheet.currentSegment.frameSize.Y - (collisionOffset.Y * 2));
            }
        }
    }
}
